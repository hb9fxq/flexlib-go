...
# Windows
env GOOS=windows GOARCH=amd64 go build -o ../../../../bin/flexlib-go/Win64/iq-transfer.exe github.com/hb9fxq/flexlib-go/cmd/iq-transfer
env GOOS=windows GOARCH=386 go build -o ../../../../bin/flexlib-go/Win32/iq-transfer.exe github.com/hb9fxq/flexlib-go/cmd/iq-transfer
